...
import particleImg from '../media/img/particle-1.png'
...
export default class Planet {
    ...
    createParticles(_object) {
        ...
        this.texture = new THREE.TextureLoader().load(particleImg)
    ...
    initControler() {
        ...
        this.controler.minPolarAngle = this.controlerProps.vAngle.min
        this.controler.maxPolarAngle = this.controlerProps.vAngle.max
